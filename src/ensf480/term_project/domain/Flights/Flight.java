...
public class Flight {
    ...
    public Flight(int flightID, String flightNumber, String departureLocation, String arrivalLocation, String dTime, String aTime, int aircraftID, BigDecimal price) {
