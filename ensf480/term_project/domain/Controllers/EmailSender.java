...
public class EmailSender {
    ...
    private static String buildEmailContent(Flight flight, Seat seat) {
        ...
        content.append("\nTotal Price: ").append(flight.getBasePrice()).append("\n\n");
    ...
    public static void sendPromoStatusEmail(String userEmail, String promoCode) {
        // Set up properties for the email server
        Properties properties = new Properties();
        properties.put("mail.smtp.host", "smtp.gmail.com"); // Replace with your email server host
        properties.put("mail.smtp.port", "465"); // Replace with your email server port
        ...
        try {
            ...
            // Set the email subject and content
            message.setSubject("Promo Code Status Notification");

            // Build the email content with promo code status details
            String emailContent = buildPromoStatusEmailContent(promoCode);
            ...
            System.out.println("Promo code status email sent successfully.");
    ...
    private static String buildPromoStatusEmailContent(String promoCode) {
        StringBuilder content = new StringBuilder();

        content.append("Dear Passenger,\n\n");
        content.append("Here is the status of the promo code you used:\n\n");

        // Add logic to check the status of the promo code and customize the email content accordingly
        ...
        if (isValidPromoCode) {
            ...
            content.append("Status: Valid\n");
            content.append("You can enjoy the discounts on your bookings.\n\n");
        } else {
            content.append("Promo Code: ").append(promoCode).append("\n");
            content.append("Status: Invalid\n");
            content.append("Please check and try again with a valid promo code.\n\n");
        }
